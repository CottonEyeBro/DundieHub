...
def create_groups():
    g1 = Group(
        ...
        group_started = datetime.datetime(month = 11, day = 30, year = 2023, hour = 1, minute = 12, second = 0, microsecond = 0, fold = 0)
    )
    g2 = Group(
        group_name = 'Bears, Beets, Battlestar Galactica Fanclub',
        group_desc = 'The only things that matter, objectively',
        group_started = datetime.datetime(month = 11, day = 30, year = 2023, hour = 1, minute = 13, second = 0, microsecond = 0, fold = 0)
    )
    g3 = Group(
    ...
    g8 = Group(
        ...
        group_started = datetime.datetime(month = 11, day = 30, year = 2023, hour = 1, minute = 19, second = 0, microsecond = 0, fold = 0)
    )
    g9 = Group(
        group_name = 'Pretzel Day Enthusiasts',
        group_desc = 'It is all about the pretzels',
        group_started = datetime.datetime(month = 11, day = 30, year = 2023, hour = 1, minute = 20, second = 0, microsecond = 0, fold = 0)
    )
...
def create_posts():
    p1 = Post(
        ...
        posted_at = datetime.datetime(month = 11, day = 30, year = 2023, hour = 7, minute = 30, second = 0, microsecond = 0, fold = 0),
        user_id = 1
    )
    p2 = Post(
        content = "I am fast. To give you a reference point, I'm somewhere between a snake and a mongoose… and a panther.",
        posted_at = datetime.datetime(month = 11, day = 30, year = 2023, hour = 7, minute = 35, second = 0, microsecond = 0, fold = 0),
        user_id = 2
    )
    p3 = Post(
        ...
        posted_at = datetime.datetime(month = 11, day = 30, year = 2023, hour = 7, minute = 55, second = 0, microsecond = 0, fold = 0),
        user_id = 3
    )
    p4 = Post(
        ...
        posted_at = datetime.datetime(month = 11, day = 30, year = 2023, hour = 8, minute = 15, second = 0, microsecond = 0, fold = 0),
        user_id = 4
    )
    p5 = Post(
        ...
        posted_at = datetime.datetime(month = 11, day = 30, year = 2023, hour = 8, minute = 45, second = 0, microsecond = 0, fold = 0),
        user_id = 5
    )
    p6 = Post(
        ...
        posted_at = datetime.datetime(month = 11, day = 30, year = 2023, hour = 9, minute = 20, second = 0, microsecond = 0, fold = 0),
        user_id = 6
    )
    p7 = Post(
        ...
        posted_at = datetime.datetime(month = 11, day = 30, year = 2023, hour = 9, minute = 30, second = 0, microsecond = 0, fold = 0),
        user_id = 7
    )
    p8 = Post(
        ...
        posted_at = datetime.datetime(month = 11, day = 30, year = 2023, hour = 9, minute = 35, second = 0, microsecond = 0, fold = 0),
        user_id = 8
    )
    p9 = Post(
        content = "I just wanna lie on the beach and eat hot dogs. That's all I've ever wanted.",
        posted_at = datetime.datetime(month = 11, day = 30, year = 2023, hour = 9, minute = 45, second = 0, microsecond = 0, fold = 0),
        user_id = 9
    )
    p10 = Post(
        content = "You got your sheep, and you got your black sheep, and I'm not even a sheep. I'm on the freakin' moon.",
        posted_at = datetime.datetime(month = 11, day = 30, year = 2023, hour = 9, minute = 50, second = 0, microsecond = 0, fold = 0),
        user_id = 10
    )
    p11 = Post(
        content = "I am super cool. I am an accountant at a failing paper supply company in Scranton. Much like Sir Ian McKellen.",
        posted_at = datetime.datetime(month = 11, day = 30, year = 2023, hour = 10, minute = 10, second = 0, microsecond = 0, fold = 0),
        user_id = 11
    )
    p12 = Post(
        ...
        posted_at = datetime.datetime(month = 11, day = 30, year = 2023, hour = 10, minute = 15, second = 0, microsecond = 0, fold = 0),
        user_id = 12
    )
...
def create_comments():
    c1 = Comment(
        ...
        commented_at = datetime.datetime(month = 11, day = 30, year = 2023, hour = 7, minute = 36, second = 0, microsecond = 0, fold = 0),
        post_id = 2,
        user_id = 1
    )
    c2 = Comment(
        content = "Identity theft is not a joke, Jim! Millions of families suffer every year!",
        commented_at = datetime.datetime(month = 11, day = 30, year = 2023, hour = 7, minute = 56, second = 0, microsecond = 0, fold = 0),
        post_id = 3,
        user_id = 2
    )
    c3 = Comment(
        content = "Now, exactly, how much pot did you smoke?",
        commented_at = datetime.datetime(month = 11, day = 30, year = 2023, hour = 7, minute = 37, second = 0, microsecond = 0, fold = 0),
        post_id = 2,
        user_id = 3
    )
    c4 = Comment(
        content = "Cool beans man. I live by the quarry. We should hang out by the quarry and throw things down there!",
        commented_at = datetime.datetime(month = 11, day = 30, year = 2023, hour = 10, minute = 11, second = 0, microsecond = 0, fold = 0),
        post_id = 11,
        user_id = 5
    )
    c5 = Comment(
        content = "Boy, have you lost your mind? 'cause I'll help ya find it!",
        commented_at = datetime.datetime(month = 11, day = 30, year = 2023, hour = 9, minute = 51, second = 0, microsecond = 0, fold = 0),
        post_id = 10,
        user_id = 6
    )
    c6 = Comment(
        content = "I thought Rajnigandha was a boy's name...",
        commented_at = datetime.datetime(month = 11, day = 30, year = 2023, hour = 8, minute = 17, second = 0, microsecond = 0, fold = 0),
        post_id = 4,
        user_id = 9
    )
    c7 = Comment(
        content = "Actually...",
        commented_at = datetime.datetime(month = 11, day = 30, year = 2023, hour = 8, minute = 46, second = 0, microsecond = 0, fold = 0),
        post_id = 5,
        user_id = 11
    )
    c8 = Comment(
        content = "WELL, MY MIDDLE NAME IS RAJNIGANDHA AND I HATE IT!!!!!",
        commented_at = datetime.datetime(month = 11, day = 30, year = 2023, hour = 8, minute = 16, second = 0, microsecond = 0, fold = 0),
        post_id = 4,
        user_id = 12
    )
